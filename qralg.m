function [Anew, eigenvalues, record] = qralg(A)
    tol = 1e-12;
    n = size(A, 1);
    Anew = A;
    record = [];
    ...
    while n > 1
        ...
        n = n - 1; % Reduce the dimension for the next smallest eigenvalue
    end
    eigenvalues(end+1) = Anew(1, 1); % The last remaining eigenvalue
end
