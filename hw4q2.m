% MATLAB code for polynomial interpolation of the Runge function using Chebyshev points
...
for n = n_values
    % Calculate the Chebyshev points ti
    ti = cos((2*(1:n) - 1) * pi / (2*n));
    ...
    % Annotate the graph
    title(['Chebyshev Interpolation of the Runge function with n = ', num2str(n)]);
    legend('Runge function', 'Interpolation polynomial', 'Location', 'Best');
